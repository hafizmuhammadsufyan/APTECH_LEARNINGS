...
<body>
    ...
    <!-- enctype="multipart/form-data" this field is required whenever there will be input:file in the form -->
    <form action="create.php" method="post" enctype="multipart/form-data">
        ...
        <input type="number" name="class" id="" required><br><br>

        <label for="">Student Image: </label>
        <input type="file" name="profileimage" id="" required><br><br>
